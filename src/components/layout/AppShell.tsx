...
function AppHeader({ onMenuClick }: { onMenuClick: () => void }) {
  ...
  return (
    <header className="h-16 shrink-0 flex items-center justify-between px-4 md:px-6 bg-white/90 backdrop-blur-md border-b border-zinc-200/80 sticky top-0 z-10 transition-colors duration-300">
...
export function AppShell() {
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-zinc-50/80 transition-colors duration-300">
