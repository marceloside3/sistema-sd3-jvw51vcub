-- =====================================================================
-- Final Consolidated RLS Migration for projects and project_areas
-- Drops ALL conflicting policies from previous migrations
-- Creates clean, unified policies that allow any authenticated user
-- to create projects where created_by = auth.uid()
-- =====================================================================
...
-- =====================================================================
-- 2. ENSURE created_by FK CONSTRAINT IS CORRECT
--    projects.created_by → public.users(id) → auth.users(id)
--    The FK to public.users is functionally equivalent since
--    public.users.id is itself a FK to auth.users.id
-- =====================================================================

DO $$
BEGIN
  -- Drop and recreate the FK to ensure it exists and is correct
  IF NOT EXISTS (
...
-- =====================================================================
-- 3. DROP ALL EXISTING POLICIES ON projects TABLE
-- =====================================================================
...
-- =====================================================================
-- 4. ENABLE RLS AND CREATE CLEAN POLICIES ON projects
-- =====================================================================
...
-- =====================================================================
-- 5. DROP ALL EXISTING POLICIES ON project_areas TABLE
-- =====================================================================
...
-- =====================================================================
-- 6. CREATE CLEAN POLICIES ON project_areas
-- =====================================================================
...
-- =====================================================================
-- 7. ENSURE SEED USER (Marcelo) EXISTS WITH CORRECT PROFILE
-- =====================================================================
...
--    Call via RPC to verify a user can create projects
-- =====================================================================
...
-- After running this migration, log in as marcelo@side3.com.br and call:
--   SELECT * FROM public.verify_project_insert_access();
-- Expected: has_access = true, user_exists_in_public_users = true
--
-- Then try creating a project via the UI at /projetos/novo
-- The INSERT should succeed because:
--   1. RLS policy projects_insert allows INSERT WHERE created_by = auth.uid()
--   2. The user exists in public.users (FK constraint satisfied)
--   3. generate_project_code() is SECURITY DEFINER (bypasses RLS)
-- =====================================================================
